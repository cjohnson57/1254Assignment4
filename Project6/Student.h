...
class Student
{
	...
	public:
		...
		double calculateAdjustedGrade() const;
		/* calculates the student's grade after dropping lowest homework and lowest quiz */
